...
const SmashRoster = () => {
    ...
    const [fighters, setFighters] = useState(
        [
            ...
            {id:81,name:'Min Min',icon:'https://www.ssbwiki.com/images/d/de/MinMinHeadSSBU.png', portrait:'https://www.smashbros.com/assets_v2/img/fighter/minmin/main.png', bg:'#F5CC5B', emblem:'https://www.ssbwiki.com/images/8/85/ARMSSymbol.svg'},
