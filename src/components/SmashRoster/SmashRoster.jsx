...
const SmashRoster = () => {
    ...
    const [fighters, setFighters] = useState(
        [
            ...
            {key:38,name:'PokemonTrainer',icon:'https://www.ssbwiki.com/images/0/09/Pok%C3%A9monTrainerHeadSSBU.png'},
            ...
            {key:73,name:'MiiSwordfighter',icon:'https://www.ssbwiki.com/images/e/ef/MiiSwordfighterHeadSSBU.png'},
            ...
            {key:78,name:'Banjo&Kazooie',icon:'https://www.ssbwiki.com/images/6/60/Banjo%26KazooieHeadSSBU.png'},
